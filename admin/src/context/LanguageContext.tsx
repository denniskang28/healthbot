...
const translations = {
  EN: {
    ...
    viewDetail: 'Details',
    noTarget: 'Any Enabled Provider',
    enabled: 'Enabled',
    back: 'Back',
    saved: 'Saved',
    llmConfigCard: 'LLM Configuration',
  ...
  ZH: {
    ...
    ruleName: '规则名称',
    serviceType: '服务类型',
    conditionJson: '匹配条件（JSON）',
    targetProvider: '目标服务商',
    addProvider: '添加服务商',
    editProvider: '编辑服务商',
    ...
    deleteRule: '删除规则',
    MEDICAL_LLM: '医疗大语言模型',
    ONLINE_CONSULTATION: '线上问诊',
    OFFLINE_APPOINTMENT: '线下预约',
    ...
    noRating: '未评分',
    rateService: '评分',
    confirmDeleteProvider: '确认删除该服务商？',
    ...
    back: '返回',
    saved: '已保存',
    llmConfigCard: 'AI模型配置',
    conditionPreset: '条件预设',
    specialty: '专科',
    GENERAL: '全科',
    CARDIOLOGY: '心内科',
    NEUROLOGY: '神经科',
